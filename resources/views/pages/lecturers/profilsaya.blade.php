                    ...
                    <div class="profile-detail">
                        <div class="profile-info">
                            ...
                            <ul class="list-unstyled list-justify">
                                <li>Nomor Induk Pegawai <span>{{$items->nip}}</span></li>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content col-md-offset-3">
            ...
            <div class="modal-body">
                <form action="{{ route('lecturers.updateBaru', $items->id) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    ...
                    {{-- <div class="form-group">
                      ...
                      <input  type="text"
                              name="nim" 
                              value="{{ old('nim') ? old('nim') : $items->nim}}" 
