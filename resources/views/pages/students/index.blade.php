                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('students.profile', $item->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-eye"></i></a>
...
<div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content col-md-offset-3">
        ...
        <h3 class="modal-title" id="exampleModalLabel">Tambah Mahasiswa</h3>
...
<div class="modal fade" id="editModal{{$it->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content col-md-offset-3">
            ...
            <div class="modal-body">
                <form action="{{ route('students.update', $it->id) }}" method="POST">
                    @method('PUT')
                    @csrf
...
<div class="modal fade" id="deleteModal{{$it->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content col-md-offset-3">
            ...
            <div class="modal-body">
                <form action="{{route('students.destroy', $it->id)}}" method="POST">
                    @csrf
                    @method('delete')
